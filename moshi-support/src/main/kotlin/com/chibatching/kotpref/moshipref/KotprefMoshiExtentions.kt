...
): AbstractPref<T> = MoshiPref(getAdapter(), { default }, key, commitByDefault)
...
public inline fun <reified T : Any> KotprefModel.moshiPref(
    ...
    MoshiPref(getAdapter(), { default }, context.getString(key), commitByDefault)
...
public inline fun <reified T : Any> KotprefModel.moshiNullablePref(
    ...
    MoshiNullablePref(getAdapter(), { default }, key, commitByDefault)
...
public inline fun <reified T: Any> getAdapter(): JsonAdapter<T> {
    return getAdapter(T::class.java)
}

public fun <T: Any> getAdapter(clazz: Class<T>): JsonAdapter<T> {
    return Kotpref.moshi?.adapter(clazz) ?: Moshi.Builder().build().adapter(clazz)
}